export const blank = {
  ...
  sections: [
    ...
    },
    {
      ...
      products: [
        {
          name: "Sage handblock last pieces",
          material: "Handblock cotton",
          price: "₹1,299",
          compareAt: "₹1,899",
          href: "/?route=clearance-sage-handblock",
          tag: "Everyday",
          media: {
            src: "/assets/design-product-sage.jpg",
            alt: "Sage green floral saree styled in a clean studio",
        ...
        {
          name: "Indigo stripe clearance drape",
          material: "Soft linen blend",
          price: "₹1,799",
          compareAt: "₹2,499",
          href: "/?route=clearance-indigo-stripe",
          tag: "Ready-to-wear",
          swatches: [
            { color: "#1f3a5f", label: "Indigo" },
            { color: "#c4a574", label: "Sand" },
        ...
        {
          name: "Marigold print final yards",
          material: "Lightweight georgette",
          price: "₹999",
          compareAt: "₹1,599",
          href: "/?route=clearance-marigold-print",
          tag: "Festive",
          media: {
            src: "/assets/design-product-marigold.jpg",
            alt: "Marigold yellow saree with a green blouse",
        ...
        {
          name: "Black border easy clearance",
          material: "Everyday cotton",
          price: "₹1,199",
          compareAt: "₹1,699",
          href: "/?route=clearance-black-border",
          tag: "Everyday",
          media: {
            src: "/assets/design-product-black.jpg",
            alt: "Black and white graphic saree with a bold border",
        ...
        {
          name: "Courtyard print clearance",
          material: "Soft handloom cotton",
          price: "₹1,099",
          compareAt: "₹1,599",
          href: "/?route=clearance-courtyard-print",
          tag: "Everyday",
          media: {
            src: "/assets/design-collection-everyday.jpg",
            alt: "Pale printed saree styled for an everyday wardrobe",
        ...
        {
          name: "Workroom indigo mark-down",
          material: "Handloom silk cotton",
          price: "₹1,499",
          compareAt: "₹2,199",
          href: "/?route=clearance-workroom-indigo",
          tag: "Work",
          media: {
            src: "/assets/design-collection-work.jpg",
            alt: "Cream, black, and maroon saree styled for work",
        ...
        {
          name: "Rust marigold clearance silk",
          material: "Silk blend",
          price: "₹1,999",
          compareAt: "₹2,699",
          href: "/?route=clearance-rust-marigold",
          tag: "Wedding",
          media: {
            src: "/assets/design-collection-festive.jpg",
            alt: "Red and marigold saree styled for a festive occasion",
        ...
        {
          name: "Coral easy-drape clearance",
          material: "Lightweight organza",
          price: "₹1,699",
          compareAt: "₹2,399",
          href: "/?route=clearance-coral-drape",
          tag: "Ready-to-wear",
          media: {
            src: "/assets/design-collection-ready-to-wear.jpg",
            alt: "Pastel striped saree styled for ready-to-wear ease",
